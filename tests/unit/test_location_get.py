...
def test_location_list_limit_all_hubs(setup_s3_dynamodb):
    event = {
        "httpMethod": "GET",
        "rawPath": "/ese/v1/location/list",
        "pathParameters": {},
    ...
    hubs = json.loads(response["body"])["hubs"]
    assert len(hubs) == 2
    assert hubs == sorted(hubs, key=lambda hub: hub["hub_id"])


def test_location_list_limit_dynamic_hubs(setup_s3_dynamodb):
    table = boto3.resource("dynamodb", region_name=constants.DEFAULT_REGION).Table("locations")
    table.put_item(
        Item={
            "hub_id": "LOC_123",
    ...
    event = {
        ...
        "rawPath": "/ese/v1/location/list",
        "pathParameters": {},
        "queryStringParameters": {"type": "dynamic", "limit": "1"},
    }
...
def test_location_list_limit_monitored_hubs(setup_s3_dynamodb):
    event = {
        "httpMethod": "GET",
        "rawPath": "/ese/v1/location/list",
        "pathParameters": {},
        "queryStringParameters": {"type": "monitored", "limit": "1"},
    }
...
def test_location_list_invalid_limit_non_integer(setup_dynamodb):
    event = {
        "httpMethod": "GET",
        "rawPath": "/ese/v1/location/list",
        "pathParameters": {},
...
def test_location_list_invalid_limit_zero(setup_dynamodb):
    event = {
        "httpMethod": "GET",
        "rawPath": "/ese/v1/location/list",
        "pathParameters": {},
